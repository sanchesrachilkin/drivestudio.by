...
class RSFirewallModelCheck extends JModelLegacy
{
	...
	public function checkRSFirewallVersion() {
		...
		$url 	 = 'http://www.rsjoomla.com/index.php?option=com_rsfirewall_kb&task=version&version=firewall&current='.urlencode($current).'&firewall='.urlencode((string) $version);
