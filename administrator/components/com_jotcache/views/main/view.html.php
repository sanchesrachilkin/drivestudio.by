...
protected $filters;
  protected $pars;
protected $url = "http://kbase.jotcomponents.net/jotcache:help:direct53j3x:";
protected $sidebar;
protected $canManage;
...
$document->addScript('components/com_jotcache/assets/jotcache.js?ver=5.3.2');
$document->addStyleSheet('components/com_jotcache/assets/jotcache.css?ver=5.3.2');
...
$this->pars->domain = '0';
}if ($this->pars->domain && $this->lists['current_Domain']) {
