...
(function (jQuery) {
    jQuery.plusGallery = function (el, options) {
        ...
        jQuery.plusGallery.init = function () {
            ...
            _doc.on("click", "#pgthumbhome", function (e) {
                ...
                jQuery('#pgalbums').removeClass('al-active');
            ...
            _doc.on('click', '.plus-pagination', function (e) {
                ...
                jQuery('#pgalbums').addClass('al-active');
                    ...
                    if (albumTotal > 0) {
                        jQuery.each(objPath, function (i, obj) {
                            if (i < albumTotal) {
                                ...
                                galleryJSON = 'https://graph.facebook.com/' + obj.id + '/photos?limit=' + pg.limit + '&access_token=' + pg.accessToken+'&fields=images,name,link';
        ...
        jQuery.plusGallery.loadSingleAlbum = function () {
            ...
            switch (pg.type) {
                case 'google':
                    ...
                    // url = 'https://picasaweb.google.com/data/feed/api/user/' + pg.userId + '/album/' + pg.albumId + '?kind=photo&access=public&alt=json';
                ...
                case 'flickr':
                    ...
                    break;
                case 'facebook':
                    url = 'https://graph.facebook.com/' + pg.albumId + '/photos?limit=' + pg.limit + '&access_token=' + pg.accessToken+'&fields=images,name,link';
                    jQuery.plusGallery.loadGallery(url);
                    break;
                case 'instagram':
    ...
    jQuery.plusGallery.default = {
        imagePath: 'modules/mod_tz_plus_gallery/images/plusgallery',
        type: null,
