...
$doc->addScript('modules/mod_tz_plus_gallery/js/resizeimage.js');
$doc->addScript('modules/mod_tz_plus_gallery/js/plusgallery_resize.js');
$doc->addScript('modules/mod_tz_plus_gallery/js/masonry.pkgd.js');
$doc->addScript('modules/mod_tz_plus_gallery/js/imagesloaded.pkgd.js');
$doc->addScript('modules/mod_tz_plus_gallery/js/masonry.js');
$doc->addScript('modules/mod_tz_plus_gallery/js/plusgallery_aragon.js');
$doc->addStyleSheet('modules/mod_tz_plus_gallery/css/aragon.css');
$doc->addStyleSheet('modules/mod_tz_plus_gallery/css/style.css');



$width = 100 / $tz_columns;
$width_album = 100 / $params->get('tz_columns_album',1);
$width_album_small = 100 / $params->get('tz_columns_small_desktop',1);
$width_album_tablet = 100 / $params->get('tz_columns_tablet',1);
$width_album_mobile = 100 / $params->get('tz_columns_mobile',1);
...
if ($height_item) {
    $style = '
        body #plusgallery' . $module->id . ' .aragon .effect3 {
...
$doc->addStyleDeclaration('
    ...
    body #plusgallery' . $module->id . ' .pgthumb{
       ...
       body #plusgallery' . $module->id . ' .pgthumb .effect3{
        margin: ' . $tz_padding . ';
    }
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        <?php
        $link = JUri::base(true) . '/modules/mod_tz_plus_gallery/images/plusgallery';
        $params_plus = '{
			imagePath: "' . $link . '",
            responsive:{
                desktop: 5,
