...
if ($params->get('tz_use_font_icon', 0)) {
    $doc->addStyleSheet(JUri::base() . 'modules/mod_tz_plus_gallery/css/font-awesome.css');
}
...
$tz_columns = $params->get('tz_columns',1);
...
$layout = $params->get('layout', 'aragon');
$moduleclass_sfx = htmlspecialchars($params->get('moduleclass_sfx'));
require JModuleHelper::getLayoutPath('mod_tz_plus_gallery', $layout);
